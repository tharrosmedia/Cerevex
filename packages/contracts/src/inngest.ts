...
export const SEO_EVENTS = {
  ...
  gscRecommendationsRequested: "seo/gsc.recommendations.requested",
  gscApplyRequested: "seo/gsc.apply.requested",
...
export const SEO_FUNCTION_IDS = {
  ...
  gscRecommendations: "seo-gsc-recommendations",
  gscApply: "seo-gsc-apply",
  audit: "seo-audit",
  wordpressSync: "seo-wordpress-sync",
  wordpressApply: "seo-wordpress-apply",
} as const;
