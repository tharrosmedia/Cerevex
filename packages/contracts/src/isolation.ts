 ...
 *   (Brain `Cerevex`, ads `cerevex-ads`) share Cloud keys so ads sync cannot clobber seo.
 *   Brain env key is INNGEST_APP_ID. Ads env key remains OS_INNGEST_APP_ID.
 *   Neon schema remains `os` (ADS_DB_SCHEMA quarantine).
